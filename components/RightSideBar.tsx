...
const RightSideBar = ({ user, transactions, banks } : RightSidebarProps) => {
  return (
    <aside className='right-sidebar border border-amber-400'>
        <section className='flex flex-col pb-8 border border-amber-400'>
            ...
            <div className='profile'>
                ...
                <div className='profile-details'>
                    ...
                    <p className='text-[16px] font-normal text-gray-600'>{user.email}</p>
                </div>
            </div>
        </section>
